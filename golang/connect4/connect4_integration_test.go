...
func Test_findBestMove_win(t *testing.T) {
	...
	assert.Equal(t, ConnectFourAction{3, 1}, searchTree().FindBestMove(ConnectFour{board, 1}, 1000))
}
...
func Test_findBestMove_createFork(t *testing.T) {
	...
	assert.Equal(t, ConnectFourAction{4, 1}, searchTree().FindBestMove(ConnectFour{board, 1}, 100000))
}
